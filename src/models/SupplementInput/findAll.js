...
export const findAll = async (nameSupplement, nameSupplementCategory, inputDate) => {
  try {
    let supplementInputs = await conn
      .select([
      ...
      .join('supplementcategories', 'supplementinputs.SupplementCategories_idSupplementCategory', '=', 'supplementcategories.idSupplementCategory')
      .where(function () {
